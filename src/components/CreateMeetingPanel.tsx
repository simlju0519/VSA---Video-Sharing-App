...
export default function CreateMeetingPanel({ loading, onQuickMeeting, onCustomMeeting }: Props) {
  ...
  // Reset active quick button when loading finishes
  ...
  return (
    <div className="border border-neutral-200 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-800/50 overflow-hidden">
      ...
      <button
        ...
        className="w-full px-4 py-3 text-left text-sm text-neutral-500 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition flex justify-between items-center"
      >
      ...
      {showCustom && (
        <form onSubmit={handleSubmit} className="p-4 pt-0 flex flex-col gap-3">
          <input
