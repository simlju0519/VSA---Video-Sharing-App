            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 sm:py-1.5 rounded-md text-sm text-neutral-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 transition sm:opacity-0 sm:group-hover:opacity-100"
                >
                  ✕
                </button>
              </div>
